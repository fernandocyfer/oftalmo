...
export default function Banner(props) {
    ...
    return (<div className="flex flex-col items-center justify-center min-h-screen">
        <div
            ...
            style={id === 5 ? {
                background: `url('${emergencia.src}')`, height: '55vh', display: 'flex', justifyContent: 'center'
            } : id === 6 ? {
                ...
                background: `url('${cirurgias.src}')`, height: '511px'
            } : id === 2 ? {
                background: `url('${equipeBanner.src}')`, height: '511px'
            } : id === 4 ? {
