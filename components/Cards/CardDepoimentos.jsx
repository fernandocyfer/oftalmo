    ...
    <div className={styles.Testimonial}>
      <div className={styles.TestimonialContent}>
        ...
        <div className={styles.TestimonialText}>
          <p>
            São muito simpáticos e prestam ótimo atendimento desde o balcão até
            as consultar. Passamos no oftalmo adulto, oftalmo pediatria e na
            contatologa, todos muito atenciosos! A clínica é organizada e limpa
            (e ainda tem uma máquina de café e cappuccino de graça).
          </p>
        </div>
      </div>
    </div>
