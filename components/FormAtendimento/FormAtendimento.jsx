...
const FormAtendimento = ({hasContact = true}) => (<>
        ...
        <div className="container">
            <div className="row">
                <div className="col-12">
                    <Container idLabel={2} label={'FALE AGORA CONOSCO'}
                               title={'Agende rapidamente sua consulta ou tire todas as suas dúvidas.'}
                               content={'Nossa central de atendimento funciona 24h por dia. Entre em contato por telefone ou WhatsApp. Nossa equipe está pronta para lhe atender.'}
                               dark={true}/>
                    ...
                    {
                        hasContact ? (
                            <div className={styles.FormContainer} style={hasContact ? ({marginBottom: '-40%'}) : null}>
    ...
    <div className={styles.SectionFourteen} style={hasContact ? ({padding: '15rem 0'}) : null}>
    </div>
</>)
