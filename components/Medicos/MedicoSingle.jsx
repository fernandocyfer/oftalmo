  ...
  return (
    <>
      <Link href={'/equipe/' + medico?.id}>
        <div className={styles.medicosSingle} style={{ cursor: 'pointer' }}>
          <div className={styles.medicosSingle_Photo}>
            <img
              src={
                medico?.image?.length.toString() > 1 && medico.image !== null
                  ? medico.image
                  : erro.src
              }
          ...
          <div className={styles.medicosSingle_Description}>
            ...
            <p>
              {medico?.especialidadeonmedico
                ? medico.especialidadeonmedico?.map((esp, index) => {
