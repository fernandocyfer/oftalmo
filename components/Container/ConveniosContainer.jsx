  ...
  return (
    <>
      <div className={styles.ConveniosContainer}>
        ...
        <p>
          Realizamos atendimentos oftalmológico de consultas particulares e
          convênios. Portanto, veja <br />
          abaixo nossos convênios e marque sua consulta com um de nossos
          especialistas. <br />
          No entanto, em caso de emergência oftalmológica, atendemos na unidade
          da Barra da Tijuca.
        </p>
      </div>
    </>
