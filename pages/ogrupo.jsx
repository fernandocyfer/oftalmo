            ...
            <div className="container-xxl">
                <div className="row justify-content-center">
                    <div className={styles.Hero}>
                        <h1>O Grupo</h1>
                        <p>
                            O Grupo Americas Oftalmocenter conta com 5 clínicas oftalmológicas no Rio de Janeiro.
                            Nossa estrutura
                            foi pensada para atender pacientes com praticidade e excelência no atendimento. Nosso
                            corpo clínico
                            altamente especializado conta com mais de 80 oftalmologistas, preparados para prestar
                            atendimento de
                            excelência em todas as áreas da oftalmologia.
                        </p>
                    ...
                    <div className="col-12">
                        <div className={styles.Contact}>
                            <div className={'justify-content-center align-items-center'}>
                                <ul style={{width: '40%', margin: '0 auto', textAlign: 'left'}}>
