    ...
    <>
          ...
          <div>
            <div className={styles.SelectBox}>
              <CardDiferencialFirst
                ...
                description={
                  'Garantimos que todos os nossos oftalmologistas são altamente qualificados para lhe atender'
                }
                image={diferencial1}
              />
              <CardDiferencialFirst
                ...
                description={
                  'Nossas unidades possuem equipamentos modernos para prover os melhores resultados.'
                }
                image={diferencial2}
              />
              <CardDiferencialFirst
                ...
                description={
                  'Contamos com centro cirúrgico próprio com os equipamentos mais modernos para realizar cirurgias oculares.'
                }
                image={diferencial3}
              />
              <CardDiferencialFirst
      ...
      <div className={styles.SectionFour}>
        ...
        <Container
          ...
          star
          content={
            'Nossa equipe conta com uma equipe de médicos oftalmologistas capacitados para a realização do tratamento de todas essas especialidades. Além disso, utilizamos os equipamentos mais modernos disponíveis e contamos com profissionais com vasta experiência.'
          }
          idLabel={3}
        >
          <div className={styles.mtodoido}>
      ...
      <div className={styles.SectionFive}>
        ...
        <Container
          ...
          content={
            'Nosso corpo clínico é composto por mais de 65 médicos oftalmologistas prontos para lhe atender em todas as áreas clínicas e cirúrgicas da oftalmologia. São profissionais comprometidos em prestar aos nossos pacientes o mais alto nível de qualidade e segurança.'
          }
          title={
            'Aqui você encontra os melhores oftalmologistas do Rio de Janeiro'
          }
          idLabel={1}
        ></Container>
          ...
          <div className="row">
            ...
            <div className="col-7 d-flex flex-column">
              ...
              <Container
                ...
                title={
                  'Todas as nossas unidades contam com médicos oftalmologistas pediátricos para atender nossos pequenos pacientes.'
                }
                content={
                  'Preparamos uma unidade temática na Barra da Tijuca para receber os seus filhos com muito carinho.Personagens temáticos, parquinho e ambiente infantil fazem da consulta das crianças uma experiência lúdica.'
                }
              ></Container>
              <p
                style={{
