    ...
    return (<>
        ...
        <div className={styles.SectionTwoMobile}>
            ...
            <div className='container p-4'>
                <Image src={containerBackgroundDoisMobile} alt={'Criança realizando exame'}
                       title={'Criança realizando exame'} layout={'responsive'}/>
            </div>
        ...
        <div className={styles.SectionTwo}>
            <div className={styles.SectionTwo_container}>
                <div className='container d-flex align-items-center justify-content-center'
                     id='containerDoisSobreposto' style={{background: ''}}>
                    <div className="col-4">
                        <Image src={containerBackgroundDois} alt={'Criança realizando exame'}
                               title={'Criança realizando exame'} layout={'responsive'}/>
                    </div>
                    <div className="col-8">
                        <div className={styles.SectionTwo_boxTwo}>
        ...
        <div className={styles.SectionFour}>
            ...
            <Container
                ...
                <div className={styles.mtodoido}>
                    ...
                    <CardEspecialidades title={'Lentes de contato'} image={cardEspecialidades8}/>
                </div>
        ...
        <div className={styles.SectionFive}>
            ...
            <Container label={'Nossos médicos'}
                       ...
                       title={'Aqui você encontra os melhores oftalmologistas do Rio de Janeiro'} idLabel={1}>
        ...
        <div className={styles.SectionSeven}>
            <div className="container" style={{background: 'rgba(207, 207, 207, 0.15)'}}>
                <div className="row">
                    ...
                    <div className="col-7 d-flex flex-column">
                        ...
                        <p style={{textAlign: 'left', padding: '0.5rem 1rem', marginTop: '-1rem'}}>Acesse o site
                            da <b>Americas OftalmoKids</b> para saber mais.</p>
                        <Button title={'Visitar Oftalmokids'} id={1} to={'/oftalmokids'}/>
                    </div>
                </div>
            </div>
