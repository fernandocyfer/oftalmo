        ...
        <div className="row d-flex justify-content-center">
          <div className="col-6">
            <div className={styles.Hero}>
              ...
              <p>
                Conheça as cirurgias oftalmológicas oferecidas pela Americas
                Oftalmocenter e veja como a nossa equipe de médicos pode ajudar
                você a cuidar da saúde dos seus olhos:
              </p>
