        ...
        <div className="row d-flex justify-content-center">
          <div className="col-6">
            <div className={styles.Hero}>
              ...
              <p>
                Na Americas Oftalmocenter você consegue realizar seus exames
                oftalmológicos no Rio de Janeiro com a qualidade e atendimento
                de profissionais capacitados. Se você está procurando um
                oftalmologista no Rio de Janeiro para realizar um exame de
                vista, diagnosticar alguma doença ocular ou outros exames
                oftalmológicos, confira a lista abaixo e agende agora sua
                consulta.
              </p>
