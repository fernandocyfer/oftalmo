...
import familiaOlhinho from '/public/banner/familiaOlhinho.svg'
...
import rodape from '/public/banner/rodape.svg';
...
const Oftalmokids = () => (<>
    <Banner id={7}>
        <div className={styles.oftamokidsContainer}>
            <div className={'container-xl'}>
                ...
                <p>
                    Com muito carinho, diversão e qualidade no atendimento às suas crianças.
                    Americas Oftalmocenter é a casa dos melhores oftalmologistas infantis. Além disso, preparamos um
                    ambiente único no Rio de Janeiro para atender nossos pequenos pacientes.
                </p>
            ...
            <div className={'row d-flex justify-content-evenly'}>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="57" height="51" viewBox="0 0 57 51" fill="none">
                            ...
                            <defs>
                                <clipPath id="clip0_2247_12568">
                                    <rect width="56" height="50.1333" fill="white" transform="translate(0.5)"/>
                                </clipPath>
                            </defs>
                        </svg>
                        <h4>Nosso espaço Kids</h4>
                        <p>
                            Construímos um espaço moderno e original na Unidade Barra da Tijuca dedicado inteiramente à
                            oftalmopediatria. São dois consultórios e entretenimento garantido para as crianças em um
                            ambiente lúdico.
                        </p>
                ...
                <div className={'col-3'}>
                    <div className={styles.card}>
                        ...
                        <p>
                            Doutor Olhinho, Unicórnea e outros estão ansiosos para conhecer você. Uma família inteira de
                            personagens exclusivos que ensinam e divertem cada criança ao longo de nossos dedicados
                            atendimentos.
                        </p>
                ...
                <div className={'col-3'}>
                    <div className={styles.card}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="47" height="56" viewBox="0 0 47 56" fill="none">
                            ...
                            <defs>
                                <clipPath id="clip0_2247_12590">
                                    <rect width="46" height="56" fill="white" transform="translate(0.5)"/>
                                </clipPath>
                            </defs>
                        </svg>
                        ...
                        <p>
                            Para todo tipo de necessidade, temos uma equipe de oftalmologistas infantis especializados
                            selecionados para atender cada caso do nosso querido público mais jovem. Toda criança merece
                            ter sua saúde ocular em dia e bem tratada.
                        </p>
                        <Button title={'Conheça nossos oftalmologistas pediatricos '} id={14}/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className={'container'}>
            <div className={'row'}>
                <div className={'col-12 d-flex justify-content-center align-items-center flex-column'}>
                    ...
                    <p>
                        Nosso espaço é localizado no Shopping Città America, na Avenida das Américas, 700, Bloco 08,
                        Barra da Tijuca. Em um ambiente colorido e cheio de atrações divertidas, as crianças encontram
                        entretenimento e conhecimento em uma área exclusiva e segura. Há estacionamento no local e o
                        acesso é fácil pelo BRT ou Metrô.
                    </p>
                    <Button id={5} title={'Agendar consulta'}/>
                </div>
            </div>
    ...
    <div className={styles.familiaOftalmo} style={{backgroundImage: `url('${familiaOlhinho.src}')`}}>
        <div className={'container'}>
            <div className={'row'}>
                <div className={'col-12 d-flex flex-column justify-content-center text-center align-items-center'}>
                    <h5>Família Olhinho</h5>
                    <h4>A visão de sua criança bem cuidada.</h4>
                    <p>
                        Cada oftalmologista infantil da nossa equipe é um especialista com experiência, empatia e
                        comprometimento com a saúde do paciente. Nosso espaço conta com equipamentos de última geração
                        que garantem as melhores práticas em oftalmopediatria. E as crianças ainda podem brincar e
                        aprender em nosso espaço Kids, recheado de personagens e atividades exclusivas que tornam a
                        visita uma experiência prazerosa e memorável para todos.
                    </p>
                </div>
            </div>
            <div className={'row familiaOftalmo'}>
                <div className={styles.overlayOlhinhos}>
                    ...
                    <div className={styles.familiaOlhinhoSlide}>
                        ...
                        >
                            <SwiperSlide>
                                <div className={styles.boxOlhinho}><Image src={fam1}/>
                                    <p>Dr. Olhinho</p></div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className={styles.boxOlhinho}><Image src={fam2}/>
                                    <p>Unicórnea</p></div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className={styles.boxOlhinho}><Image src={fam3}/>
                                    <p>Vovô Catarata</p></div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className={styles.boxOlhinho}><Image src={fam4}/>
                                    <p>Vovó Catarata</p></div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className={styles.boxOlhinho}><Image src={fam5}/>
                                    <p>Arco-íIris</p></div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className={styles.boxOlhinho}><Image src={fam6}/>
                                    <p>Pupila</p></div>
                            </SwiperSlide>
                        </Swiper>
    ...
    <div className={'container-xxl'}>
        <div className={styles.containerColorir}>
            ...
            <div className={styles.desc}>
                ...
                <p>
                    Um kit de ilustrações com toda a Família Olhinho! Use à vontade nosso material em PDF. Ele pode ser
                    impresso em casa para as crianças colorirem quando quiserem.
                </p>
